...
public class PassordUtil {
	...
	/**
	 * @return et tilfeldig generert 16 bytes salt ved aa bruke SHA1PRNG
	 */
	 ...
	 * 
	 * Algoritmen som brukes er PBKDF2WithHmacSHA1 - PBKDF2:
	 * Password-Based-Key-Derivation-Function - WithHmac: HMAC står for Keyed-Hash
	 * Message Authentication Code - SHA1: SHA1 hashing-algoritme
	 * 
	 * Det itereres 1000 ganger. Output fra denne algoritmen er 256 bits, dvs. 32
	 * bytes.
	 * 
